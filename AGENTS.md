...
`src/data/` is the separate `blog-data` Git submodule containing posts, snippets, clips, and attachments. Initialize it with `git submodule update --init --recursive` before changing content.
